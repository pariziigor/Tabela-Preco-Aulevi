...
export const CommercialConditions = ({ data }: CommercialProps): JSX.Element | null => {
  ...
  const renderList = (items: string[]) => {
    return items.map((item, index) => (
      <p key={index} className="leading-tight mb-0.5 last:mb-0">
        {item}
      </p>
    ));
  };
  ...
  return (
    <div className="w-full mt-6 border border-gray-300 rounded-lg overflow-hidden shadow-sm bg-white">
      ...
      <div className="grid grid-cols-3 divide-x divide-gray-300">
        <div className="flex flex-col">
          ...
          <div className="p-4 text-sm text-gray-600 text-center min-h-[50px] flex items-center justify-center font-medium">
