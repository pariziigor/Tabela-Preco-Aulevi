...
// Adicionamos currentMonth nas propriedades que o modal recebe
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-10">
          ...
          {/* NOVA SEÇÃO: CONFIGURAÇÕES GERAIS */}
          <section>
            ...
            <div className="p-5 bg-gray-50 rounded-xl border border-gray-200 shadow-sm flex flex-col">
              ...
              <div className="flex gap-3 w-full md:w-2/3">
                ...
                <select 
                  ...
                  // Aqui o onChange junta o mês selecionado com o ano atual do computador
                ...
                {/* Ano Automático (Fixo e bloqueado para edição) */}
                <div 
              ...
              {formData.map((cat: any) => {
                ...
                return (
                  <div key={cat.id} className="p-5 bg-gray-50 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    {/* NOVO BLOCO: Preços Globais do Steel Frame */}
                    {isSteelFrame && (
                      <div className="flex gap-4 mb-4 p-4 bg-orange-50/80 rounded-lg border border-aulevi-orange/20 shadow-inner">
                        <div className="flex-1 flex flex-col gap-1.5">
                          ...
                          <input 
                            ...
                            onChange={(e) => handleCategoryChange(cat.id, 'precoAbaixo', e.target.value)} 
                        ...
                        <div className="flex-1 flex flex-col gap-1.5">
                          ...
                          <input 
                            ...
                            onChange={(e) => handleCategoryChange(cat.id, 'precoAcima', e.target.value)} 
                    ...
                    <div className="space-y-2">
                      {cat.produtos.map((prod: any) => (
                        <div key={prod.id} className="flex gap-2 group items-center">
                          ...
                          {/* UND e Valor individuais somem se for Steel Frame */}
                          {!isSteelFrame && (
                            <>
                              ...
                              <input className="w-32 p-2.5 border rounded-lg text-sm text-right focus:border-aulevi-orange outline-none font-bold text-gray-700" value={prod.valor} onChange={(e) => handleProductChange(cat.id, prod.id, 'valor', e.target.value)} placeholder="R$ 0,00" />
                            </>
                          )}
          ...
          {/* Condições Comerciais (mantido igual) */}
        ...
        <div className="flex justify-end gap-4 p-6 border-t bg-gray-50 rounded-b-lg">
          ...
          {/* Atualizamos o botão de salvar para enviar a variável 'month' de volta ao App.tsx */}
          <button 
